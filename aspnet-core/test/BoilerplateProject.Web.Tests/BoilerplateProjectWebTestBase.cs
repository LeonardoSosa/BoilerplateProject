...
{
    public abstract class BoilerplateProjectWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static BoilerplateProjectWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(BoilerplateProjectWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<BoilerplateProjectDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<BoilerplateProjectDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<BoilerplateProjectDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<BoilerplateProjectDbContext, Task<T>> func)
        {
            T result;
